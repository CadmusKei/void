...
export default function ChatCard({Voidling, profileImage, lastMessage, onClickFunction}) {
  return (
    ...
    <div onClick={() => onClickFunction(Voidling)} className="flex items-center w-full min-h-[14%] bg-[#191919] 
    border-[#191919]  p-3 space-x-4 active:bg-[#292929] active:shadow-xl active:z-50 1active:shadow-[#101010]">
